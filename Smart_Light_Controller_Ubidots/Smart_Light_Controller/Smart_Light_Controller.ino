...
#define DEVICE  "smartlight"  // Put here your Ubidots device label
#define VARIABLE01  "led"  // Put here your Ubidots variable label
#define VARIABLE02 "lightvalue"
...
void lightSensor() {
    ...
    client.add("5d0b335dc03f971273a06193", outValue);
    client.sendAll();
    delay(1000);
 }
